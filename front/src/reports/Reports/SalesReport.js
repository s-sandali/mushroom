...
import './SalesReport.css'; // Uses your existing styling
...
export default function SalesReport() {
  ...
  const fetchSalesReport = useCallback(async () => {
    ...
    setError('');
    try {
      const response = await axios.get(buildApiUrl('/api/reports/sales'), {
    ...
    <div className="sales-report-page">
      <div className="report-card">
        ...
        <div className="report-header mb-4 d-flex align-items-center">
          ...
          >
            <i className="bi bi-bar-chart-line text-white" style={{ fontSize: '2rem' }}></i>
          </div>
          <div className="header-content">
            <h2 className="report-title mb-0">Sales Reports</h2>
            <div className="report-subtitle">Comprehensive Sales Performance Analysis</div>
          </div>
        </div>
